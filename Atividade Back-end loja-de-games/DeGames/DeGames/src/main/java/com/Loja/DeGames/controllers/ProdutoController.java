package com.Loja.DeGames.controllers;
...
import com.Loja.DeGames.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>>GetByJogos (@PathVariable  String jogos){
	...
	public @PutMapping ResponseEntity<Produto> put (@RequestBody Produto produto){
